...
resolutions_4s, Tlist_4s, errors = [], [], []
...
plt.errorbar(Tlist_4s, resolutions_4s, yerr=errors, capthick=0.5, label = 'Data')
...
plt.savefig('enc-gaussFilter-4s-20K.png')
...
# Save as .csv file: 
df_freq_4s.to_csv('enc-gaussFilter-4s-20K.csv')