...
from sipm_signalProcessing import plot_filteredPulses, get_amplitudes
...
amplitudes, integrals = get_amplitudes(pathToData, 20000, 0.03, 0.02, minR, maxR, header); 
...
#--------EDIT--------- 
x, y = sipm_dataAnalysis.get_PHSspectrum(amplitudes, 100, -0.3, 0., vbias, connection, sipmN);
...
x, y = sipm_dataAnalysis.get_PHSspectrum(amplitudes, 100, xMin, xMax, vbias, connection, sipmN);
