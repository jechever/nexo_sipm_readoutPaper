"""
Full analysis script for 2019 SiPM paper. Makes ENC fits for 4-SiPMs 
(2s2p) for t-rise dependence study, using the triangular filter. Uses sample 
...
if __name__ == "__main__":
    ...
    enc_series_triang_6sipm = df_series_triang['ENC-2p2s'].tolist()
    
    # Initiate lists for observables:
    resolutions_4s, errors, Tlist_4s  = [], [], []
    # EXPECTED VALUES 
    ...
    # ----------------------------- 25 ns -----------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 25; Tlist_4s.append(peakingTime)
    ...
    delt, sig = fits.singleFitter(x[xMin:xMax],y[xMin:xMax],x,y, expected1, plotting = 0); 
    ...
    # ----------------------------- 50 ns -----------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 50; Tlist_4s.append(peakingTime)
    ...
    # ----------------------------- 75 ns -----------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 75; Tlist_4s.append(peakingTime)
    ...
    # ------------------------------- 100 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 100; Tlist_4s.append(peakingTime)
    ...
    # ------------------------------- 100 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 125; Tlist_4s.append(peakingTime)
    ...
    # ------------------------------- 100 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 150; Tlist_4s.append(peakingTime)
    ...
    # ------------------------------- 100 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 175; Tlist_4s.append(peakingTime)
    ...
    # -------------------------------200 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 200; Tlist_4s.append(peakingTime)
    ...
    # -------------------------------225 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 225; Tlist_4s.append(peakingTime)
    ...
    # -------------------------------250 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 250; Tlist_4s.append(peakingTime)
    ...
    # ------------------------------- 275 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 275; Tlist_4s.append(peakingTime)
    ...
    # ------------------------------- 300 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 300; Tlist_4s.append(peakingTime)
    ...
    resolutions_4s.append(abs(sig1));
    #resolutions_4s.append(abs(sig1)/abs(mu1-mu2)); 
    plt.xlim(0.5, 3.5); #plt.ylim(0, 0.8); 
    
    #plt.figure(); plt.plot(y)
    
    # ------------------------------- 350 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 350; Tlist_4s.append(peakingTime)
    ...
    # ------------------------------- 400 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 400; Tlist_4s.append(peakingTime)
    ...
    # ------------------------------- 450 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 450; Tlist_4s.append(peakingTime)
    ...
    # ------------------------------- 500 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 500; Tlist_4s.append(peakingTime)
    ...
    # ------------------------------- 600 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 600; Tlist_4s.append(peakingTime)
    ...
    # ------------------------------- 700 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 700; Tlist_4s.append(peakingTime)
    ...
    # ------------------------------- 700 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 800; Tlist_4s.append(peakingTime)
    ...
    # ------------------------------- 900 ns ---------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 900; Tlist_4s.append(peakingTime)
    ...
    # ------------------------------- 1000 ns --------------------------------------
    # Set peaking time:  
    peMin = 0.015; peMax = 0.028; peakingTime = 1000; Tlist_4s.append(peakingTime); 
    ...
    plt.errorbar(Tlist_4s, resolutions_4s, yerr=errors, fmt='o', capsize = 2, capthick=2, label = 'Data')
    plt.plot(tpeak_series_triang, enc_series_triang_6sipm, 'r', label = 'Model')
    plt.title('Triangular filter, 4 SiPMs: 2s2p, $V_{over}$ = 4.5 V') ; 
    plt.xlabel('$t_{peak}$ (s)'); plt.ylabel('enc ( s.p.e.)');
    plt.grid(); plt.show(); plt.yscale('log'); plt.xscale('log'); plt.legend()
    plt.savefig('../figures/enc-tp/triangular/enc-triangFilter-4s.png')
    
    # Make pandas dataframes: 
    df_freq_4s = pd.DataFrame({'peaking time (ns)': Tlist_4s,
                    'ENC(s.p.e.)': resolutions_4s,
                    'error(s.p.e.)': errors})
                    
    # Save as .csv file: 
    df_freq_4s.to_csv('../data-output/enc-tp/triangular/enc-triangFilter-4s.csv')
