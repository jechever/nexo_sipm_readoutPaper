...
#EDIT next two lines: 470-515 for dark, 520-570 for LED
# --------------------------------------------------------------
vbias = 65; sipmN = '6'; source = 'led'; #minR = 470; maxR = 515; 
peak = 'single'; connection = 'series'; header = 0; bins = 150; bins1 = 120;
# --------------------------------------------------------------
if source == 'dark': 
    minR = 470; maxR = 515;
else: 
...
#-------- Waveform plots ------------- 
#sipm_dataAnalysis.get_filteredPlots(pathToData, 100, 0.03, header, vbias); # HEADER!!!!!!!!
phs_all, pis = sipm_dataAnalysis.getPHS(pathToData, 20000, 0.03, 0.009, minR, maxR, header); # HEADER!!!!!!!!
